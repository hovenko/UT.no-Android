...
public class PoiProvider extends ContentProvider {
    ...
    public static final String TAG = "PoiProvider";

    static public final String AUTHORITY = "no.ut.trip.poiprovider";

    static public final Uri CONTENT_URI = Uri.parse("content://" + AUTHORITY);

    static public final String MIME_SINGLE = "vnd.android.cursor.item/vnd.ut.poi";
    static public final String MIME_MULTI = "vnd.android.cursor.dir/vnd.ut.poi";

    public static final String DEFAULT_SORT_ORDER = Pois.CREATED_DATE + " DESC";
    ...
    PoiDatabaseHelper dbOpenHelper;

    @Override
    public boolean onCreate() {
	dbOpenHelper = new PoiDatabaseHelper(getContext());
	return true;
    }
